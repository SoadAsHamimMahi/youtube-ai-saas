...
export function Sidebar() {
  ...
  return (
    <div className="w-72 h-screen border-r border-white/5 bg-background flex flex-col fixed left-0 top-0 z-50 overflow-hidden" suppressHydrationWarning>
      ...
      <div className="absolute top-0 left-0 w-full h-1/2 bg-primary/5 blur-[120px] pointer-events-none" suppressHydrationWarning />
      
      <div className="p-8 relative" suppressHydrationWarning>
        <div className="flex items-center gap-3.5 group">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-black text-2xl shadow-2xl shadow-indigo-500/40 group-hover:scale-105 transition-transform duration-500 border border-white/20" suppressHydrationWarning>
            A
          </div>
          <div>
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute left-0 top-1/4 bottom-1/4 w-1 bg-primary rounded-full shadow-[0_0_10px_rgba(99,102,241,0.8)]" suppressHydrationWarning />
              )}
      ...
      <div className="p-6 mt-auto space-y-6 relative border-t border-white/5 bg-white/[0.01]" suppressHydrationWarning>
        ...
        <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5 transition-colors hover:bg-white/[0.05]" suppressHydrationWarning>
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-gray-800 to-gray-900 border border-white/10 flex items-center justify-center text-sm font-black text-gray-400" suppressHydrationWarning>
          ...
          {/* Credit Counter */}
          <div className="bg-background rounded-xl border border-white/5 p-3 flex items-center justify-between" suppressHydrationWarning>
          ...
          <button 
            ...
            className="w-full mt-4 flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 text-gray-400 hover:text-rose-500 hover:bg-rose-500/10 transition-all duration-300 font-black text-[11px] uppercase tracking-widest border border-white/5"
          >
